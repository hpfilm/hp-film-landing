...
export function TrustBar() {
  const items = [<><strong>{BUSINESS.googleRating}★</strong> en Google</>, <><strong>+{BUSINESS.googleReviews}</strong> reseñas en Google</>, <>Atención personalizada</>, <>Presupuesto por WhatsApp</>];
